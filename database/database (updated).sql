...
--------------------------------------------------------
  ...
  CREATE TABLE "NEMU_MENU_USER"."RESTORAN" 
   (	"RESTO_ID" VARCHAR2(6 BYTE), 
	...
	"IMAGE_FILENAME" VARCHAR2(255 BYTE)
   ) SEGMENT CREATION IMMEDIATE 
  PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
...
SET DEFINE OFF;
Insert into NEMU_MENU_USER.RESTORAN (RESTO_ID,NAMA_RESTO,LOKASI,NO_TELP,RANGE_HARGA,WAKTU_BUKA,IMAGE_FILENAME) values ('RS001','Nabila Steak','Jl. Gondang Timur II','08191995999','Rp 10.000 - Rp 25.000','Senin-Jumat (12.00-20.00)','nabilasteak.png');
REM INSERTING into NEMU_MENU_USER.ULASAN
SET DEFINE OFF;
Insert into NEMU_MENU_USER.ULASAN (ULASAN_ID,USER_ID,RESTO_ID,RATING,ULASAN_JUDUL) values ('UL001','US002','RS001','5','Murce banget!! Bapak Ibu nya ramah!');
REM INSERTING into NEMU_MENU_USER.USER_NEMUMENU
SET DEFINE OFF;
Insert into NEMU_MENU_USER.USER_NEMUMENU (USER_ID,USERNAME,EMAIL,PASSWORD_USER) values ('US001','Faiza','faiza@gmail.com','$2y$12$8XRao0w56cCZv/2ufbMECeDlk1kbyoRd1Mu9tk.FgaqBtVmi6qrXu');
Insert into NEMU_MENU_USER.USER_NEMUMENU (USER_ID,USERNAME,EMAIL,PASSWORD_USER) values ('US002','aufa','aufa@gmail.com','$2y$12$BQt.5qP3OLN9eGmYdWpPouNydHCgf9bmP91gb.wUxty4SWAeJo0qS');
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  USING INDEX "NEMU_MENU_USER"."RESTO_ID"  ENABLE;
--------------------------------------------------------
